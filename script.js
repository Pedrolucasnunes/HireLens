...
const MODAL_CONFIGS = {
  Starter: {
    tag:      '◆ Plano Starter',
    title:    'Garanta sua vaga<br><em>na lista de espera.</em>',
    subtitle: 'Estamos em acesso antecipado com vagas limitadas. Deixe seu e-mail e entraremos em contato assim que o plano Starter estiver disponível.',
    badge:    'Plano selecionado: Starter',
    btnLabel: 'Entrar na lista →',
  },
  Growth: {
    tag:      '◆ Acesso Antecipado',
    title:    'Você escolheu bem.<br><em>Garanta o Growth.</em>',
    subtitle: 'Estamos liberando acessos gradualmente para o plano Growth. Deixe seus dados e entre na frente da fila.',
    badge:    'Plano selecionado: Growth',
    btnLabel: 'Quero acesso antecipado →',
  },
  Enterprise: {
    tag:      '◆ Enterprise',
    title:    'Vamos conversar<br><em>sobre o seu caso.</em>',
    subtitle: 'O plano Enterprise é personalizado para cada operação. Deixe seus dados e nosso time entrará em contato para entender suas necessidades.',
    badge:    'Plano selecionado: Enterprise',
  ...
  login: {
    ...
    subtitle: 'Estamos em fase inicial e liberando acessos aos poucos. Deixe seu e-mail para ser avisado assim que o acesso estiver disponível para você.',
    badge:    null,
